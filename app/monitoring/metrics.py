...
class MetricsCollector:
    ...
    def record_classification(self, model_name: str, duration: float, confidence: float, status: str = "success"):
    ...
    def record_model_info(self, model_name: str, device: str, num_classes: int, framework: str):
