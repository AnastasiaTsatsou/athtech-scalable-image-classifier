...
class ResultsAnalyzer:
    ...
    def analyze_performance_trends(
        ...
        for test_type, test_results in results.items():
            ...
            analysis["test_summary"][test_type] = {
                ...
                "latest_avg_response_time": latest_result.get(
                    "avg_response_time", 0
                ),
                "latest_p95_response_time": latest_result.get(
                    "p95_response_time", 0
                ),
                "latest_requests_per_second": latest_result.get(
        ...
        if "classification" in analysis["test_summary"]:
            avg_response_time = analysis["test_summary"]["classification"][
                "latest_avg_response_time"
            ]
        ...
        if "stress" in analysis["test_summary"]:
            success_rate = analysis["test_summary"]["stress"][
                "latest_success_rate"
            ]
    ...
    def generate_comprehensive_report(self) -> str:
        ...
        report_file = os.path.join(
            self.analysis_dir, f"comprehensive_analysis_{timestamp}.md"
        )
        ...
        with open(report_file, "w") as f:
            ...
            for test_type, summary in analysis["test_summary"].items():
                f.write(
                    f"| {test_type} | {summary['total_tests']} | "
            ...
            if "classification" in analysis["test_summary"]:
                ...
                f.write(
                    f"- **Average Response Time**: {classification['latest_avg_response_time']:.3f}s\n"
                )
                f.write(
                    f"- **95th Percentile**: {classification['latest_p95_response_time']:.3f}s\n"
                )
                f.write(
                    f"- **Success Rate**: {classification['latest_success_rate']:.2%}\n"
                )
                f.write(
                    f"- **Throughput**: {classification['latest_requests_per_second']:.2f} RPS\n\n"
                )
            ...
            if "health" in analysis["test_summary"]:
                ...
                f.write(
                    f"- **Health Check Success Rate**: {health['latest_success_rate']:.2%}\n"
                )
                f.write(
                    f"- **Average Response Time**: {health['latest_avg_response_time']:.3f}s\n"
                )
                f.write(
                    f"- **Throughput**: {health['latest_requests_per_second']:.2f} RPS\n\n"
                )
            ...
            if "stress" in analysis["test_summary"]:
                ...
                f.write(
                    f"- **Success Rate Under Load**: {stress['latest_success_rate']:.2%}\n"
                )
                f.write(
                    f"- **Average Response Time**: {stress['latest_avg_response_time']:.3f}s\n"
                )
                f.write(
                    f"- **P95 Response Time**: {stress['latest_p95_response_time']:.3f}s\n\n"
                )
            ...
            f.write(
                "1. **System Performance**: The image classification service demonstrates "
            )
            f.write(
            ...
            f.write(
                "2. **Load Balancing**: Nginx load balancer effectively distributes "
            )
            f.write("requests across multiple service replicas.\n\n")

            f.write(
                "3. **Scalability**: The system shows good scalability characteristics "
            )
        ...
        data_file = os.path.join(
            self.analysis_dir, f"analysis_data_{timestamp}.json"
        )
    ...
    def generate_dissertation_tables(self) -> str:
        ...
        tables_file = os.path.join(
            self.analysis_dir, f"dissertation_tables_{timestamp}.md"
        )
        ...
        with open(tables_file, "w") as f:
            ...
            if "classification" in analysis["test_summary"]:
                classification = analysis["test_summary"]["classification"]
                f.write(
                    f"| Classification Success Rate | {classification['latest_success_rate']:.2%} |\n"
                )
                f.write(
                    f"| Average Response Time | {classification['latest_avg_response_time']:.3f}s |\n"
                )
                f.write(
                    f"| 95th Percentile Response Time | {classification['latest_p95_response_time']:.3f}s |\n"
                )
                f.write(
                    f"| Throughput | {classification['latest_requests_per_second']:.2f} RPS |\n"
                )
            ...
            if "stress" in analysis["test_summary"]:
                ...
                f.write(
                    f"| 95th Percentile Response Time | {stress['latest_p95_response_time']:.3f}s |\n"
                )
                f.write(
                    f"| Peak Throughput | {stress['latest_requests_per_second']:.2f} RPS |\n"
                )
