...
class PerformanceMonitor:
    ...
    def _monitor_loop(self):
        ...
        while self.monitoring:
            try:
                ...
                elapsed_time = (
                    current_time - self.start_time if self.start_time else 1
                )
    ...
    def get_metrics_summary(self) -> Dict[str, Any]:
        ...
        response_times = [
            m.response_time for m in self.metrics if m.response_time > 0
        ]
                ...
                with self.lock:
                    if self.active_sessions < self.max_connections:
                        ...
                        adapter = requests.adapters.HTTPAdapter(
                            pool_connections=1, pool_maxsize=self.max_keepalive
                        )
